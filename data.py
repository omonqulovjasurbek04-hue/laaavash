...
def standart_kategoriyalar() -> Dict[str, Any]:
    return {
        "matnlar": {
            "boshlash": "🌯 Fast-food botiga xush kelibsiz!\n\nBizning bot orqali eng mazali lavashlarni buyurtma qiling!",
            ...
            "aloqa_malumot": "📞 Biz bilan bog'lanish:\n\n📱 Telefon: +998 95 174 17 14\n📧 Email: info@laaavash.uz\n📍 Manzil: Toshkent mahalla., furqat ko'chasi 7-uy",
            "haqida_malumot": "🏪 lavash 24/7 haqida:\n\nBiz 2013 yildan beri eng mazali lavashlarni tayyorlaymiz. Bizning maqsadimiz - har bir mijozga sifatli va mazali taomlarni yetkazib berish.",
            "orqaga": "⬅️ Orqaga",
            "parol": "2013474"
        },
        "menyu": {
        ...
        "kategoriyalar": {
            "lavashlar": {
                "nomi": "🌯 Lavashlar",
                "rasm": "img/lavash_category.png",
                "mahsulotlar": {
                    "kichkina_lavash": {
                        "nomi": "Mini Lavash",
                        "tavsif": "Mol go'shti, pomidor, bodring, ketchup, mayonez",
                        "narx": 25000,
                        "id": 1
                    },
                    "katta_lavash": {
                        "nomi": "Katta Lavash (Mol go'shti)",
                        "tavsif": "Mol go'shti, chips, pomidor, bodring, ketchup, mayonez",
                        "narx": 30000,
                        "id": 2
                    },
                    "tovuqli_lavash": {
                        "nomi": "Katta Lavash (Tovuq go'shti)",
                        "tavsif": "Tovuq go'shti, chips, pomidor, bodring, maxsus sous",
                        "narx": 28000,
                        "id": 3
                    },
                    "pishloqli_lavash": {
                        "nomi": "Pishloqli Lavash",
                        "tavsif": "Go'sht, pishloq, chips, pomidor, bodring, maxsus sous",
                        "narx": 35000,
                        "id": 4
                    },
                    "qazili_lavash": {
                        "nomi": "Qazili Lavash",
                        "tavsif": "Qazi, bodring, chips, pomidor, sous",
                        "narx": 40000,
                        "id": 5
                    },
                    "qarsildoq_lavash": {
                        "nomi": "Qarsildoq Lavash",
                        "tavsif": "Karsillaydigan norin, go'sht, piyoz, pomidor, sous",
                        "narx": 32000,
                        "id": 6
                    }
                }
            ...
            "fastfood": {
                "nomi": "🍔 Burger & Xod-dog",
                "rasm": "img/burger_category.png",
                "mahsulotlar": {
                    "gamburger": {
                        "nomi": "Gamburger",
                        "tavsif": "Kotlet, bodring, pomidor, salat bargi, sous",
                        "narx": 25000,
                        "id": 7
                    },
                    "chizburger": {
                        "nomi": "Chizburger",
                        "tavsif": "Kotlet, pishloq, bodring, pomidor, salat bargi, sous",
                        "narx": 28000,
                        "id": 8
                    },
                    "bigburger": {
                        "nomi": "Dabl Burger",
                        "tavsif": "2 ta kotlet, 2 ta pishloq, bodring, pomidor, salat",
                        "narx": 38000,
                        "id": 9
                    },
                    "xoddog": {
                        "nomi": "Oddiy Xod-dog",
                        "tavsif": "Sosiska, salat, ketchup, mayonez",
                        "narx": 15000,
                        "id": 10
                    },
                    "qirollik_xoddog": {
                        "nomi": "Qirollik Xod-dog",
                        "tavsif": "Ikkita sosiska, qazi, bodring, pomidor, sous",
                        "narx": 28000,
                        "id": 11
                    },
                    "klab_sendvich": {
                        "nomi": "Klab Sendvich",
                        "tavsif": "Tost non, go'sht, pishloq, qovurilgan tuxum, bodring, fri",
                        "narx": 35000,
                        "id": 12
                    }
                }
            ...
            "pitsa": {
                 "nomi": "🍕 Pitsalar",
                 "rasm": "img/pitsa_category.png",
                 "mahsulotlar": {
                     "assorti_pitsa": {
                         "nomi": "Pitsa Assorti (32sm)",
                         "tavsif": "Qazi, kolbasa, qo'ziqorin, pishloq, zaytun",
                         "narx": 75000,
                         "id": 13
                     },
                     "peperoni": {
                         "nomi": "Pitsa Peperoni (32sm)",
                         "tavsif": "Peperoni kolbasasi, motsarella pishloq, tomat sousi",
                         "narx": 65000,
                         "id": 14
                     },
                     "margarita": {
                         "nomi": "Pitsa Margarita (32sm)",
                         "tavsif": "Motsarella pishloq, yangi pomidor, rayhon, tomat sousi",
                         "narx": 55000,
                         "id": 15
                     },
                     "qazili_pitsa": {
                         "nomi": "Qazili Pitsa (32sm)",
                         "tavsif": "Qazi, motsarella, zaytun, qo'ziqorin",
                         "narx": 80000,
                         "id": 16
                     }
                 }
            ...
            "ichimliklar": {
                "nomi": "🥤 Ichimliklar",
                "rasm": "img/drinks_category.png",
                "mahsulotlar": {
                    "kola_05": {
                        "nomi": "Coca Cola 0.5l",
                        "tavsif": "Sovuq ichimlik",
                        "narx": 8000,
                        "id": 17
                     },
                     "kola_1": {
                     ...
                     "fanta_05": {
                         "nomi": "Fanta 0.5l",
                         "tavsif": "Apelsinli sovuq ichimlik",
                         "narx": 8000,
                         "id": 19
                     },
                     "pepsi_05": {
                     ...
                     "sharbat": {
                         "nomi": "Dena sharbati 1l",
                         "tavsif": "Olma/O'rik/Olcha",
                         "narx": 18000,
                         "id": 21
                     },
                     "qahva": {
                         "nomi": "Qahva (3v1)",
                         "tavsif": "Issiq ichimlik",
                         "narx": 5000,
                         "id": 22
                     },
                     "choy": {
                         "nomi": "Choynak choy (Qora/Ko'k)",
                         "tavsif": "Limonli issiq choy",
                         "narx": 10000,
                         "id": 23
                     }
                }
            ...
            "qoshimcha": {
                "nomi": "🍟 Qo'shimcha",
                "rasm": "img/sides_category.png",
                "mahsulotlar": {
                    "fri_kichkina": {
                        "nomi": "Kartoshka fri (Kichkina)",
                        "tavsif": "Standart porsiya fri",
                        "narx": 12000,
                        "id": 24
                    },
                    "fri_katta": {
                        "nomi": "Kartoshka fri (Katta)",
                        "tavsif": "Katta porsiya fri",
                        "narx": 16000,
                        "id": 25
                    },
                    "derevenski": {
                        "nomi": "Kartoshka po-derevenski",
                        "tavsif": "Ziravorli pechda maxsus pishirilgan kartoshka",
                        "narx": 18000,
                        "id": 26
                    },
                    "pishloqli_tayoqcha": {
                        "nomi": "Pishloqli tayoqchalar",
                        "tavsif": "Qarsildoq pishloqli stiklar (5 dona)",
                        "narx": 22000,
                        "id": 27
                    },
                    "naggets": {
                        "nomi": "Tovuq naggetslari",
                        "tavsif": "Qarsildoq tovuq naggetslari (6 dona)",
                        "narx": 20000,
                        "id": 28
                    }
                }
            ...
            "shirinliklar": {
                "nomi": "🍰 Shirinliklar",
                "rasm": "img/desserts_category.png",
                "mahsulotlar": {
                    "muzqaymoq": {
                        "nomi": "Muzqaymoq 'Qaymoqli'",
                        "tavsif": "Tabiiy qaymoqli va vanilli",
                        "narx": 10000,
                        "id": 29
                    },
                    "shoko_muzqaymoq": {
                        "nomi": "Shokoladli muzqaymoq",
                        "tavsif": "Shokolad qirindilari bilan",
                        "narx": 12000,
                        "id": 30
                    },
                    "tort": {
                        "nomi": "Medovik torti",
                        "tavsif": "Asalli shirin tort bo'lagi",
                        "narx": 20000,
                        "id": 31
                    },
                    "chizkeyk": {
                        "nomi": "Nyu-York Chizkeyk",
                        "tavsif": "Klassik pishloqli desert",
                        "narx": 25000,
                        "id": 32
                    }
                }
